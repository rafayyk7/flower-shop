      ...
      <div className="relative aspect-[4/5] w-full overflow-hidden bg-cream">
        ...
        <div className="absolute inset-x-3 bottom-3 translate-y-3 opacity-0 transition-all duration-500 group-hover:translate-y-0 group-hover:opacity-100">
          <button
            ...
            disabled={justAdded}
            className={`flex w-full items-center justify-center gap-2 rounded-full px-4 py-2.5 text-sm font-medium shadow-lg backdrop-blur-sm transition-all duration-300 cursor-pointer ${
              justAdded
                ? "bg-sage text-white"
                : "bg-white text-charcoal hover:bg-dusty-rose hover:text-white"
            }`}
          >
            {justAdded ? (
              <>
